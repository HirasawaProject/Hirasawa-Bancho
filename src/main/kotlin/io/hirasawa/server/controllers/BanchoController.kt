...
class BanchoController: Controller {
    fun index(request: Request, response: Response): HttpRespondable {
        ...
        return BanchoRespondable() // TODO make this better

    }

    class BanchoRespondable: HttpRespondable() {
                    ...
                    BanchoUserLoginEvent(user, cancelReason).call().then {
                        ...
                        if (user.hasPermission("hirasawa.update.notify") && Hirasawa.isUpdateRequired) {
                            user.sendPrivateMessage(
                                Hirasawa.hirasawaBot, "You are running an outdated version of " +
