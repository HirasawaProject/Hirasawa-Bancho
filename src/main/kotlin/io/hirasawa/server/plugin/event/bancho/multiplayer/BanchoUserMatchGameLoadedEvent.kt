...
/**
 * Event that gets called whenever a user loads the beatmap in a multiplayer game
 */
class BanchoUserMatchGameLoadedEvent(val user: BanchoUser,
                                     val match: MultiplayerMatch): HirasawaEvent<BanchoUserMatchGameLoadedEvent>, Cancelable()