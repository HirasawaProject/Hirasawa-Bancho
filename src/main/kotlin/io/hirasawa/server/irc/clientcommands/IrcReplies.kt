...
class RplMotdStart(motdLine: String): NumericIrcReply(host, NumericReply.RPL_MOTDSTART, ":$motdLine")
class RplMotd(motdLine: String): NumericIrcReply(host, NumericReply.RPL_MOTD, ":$motdLine")
class RplEndOfMotd(motdLine: String): NumericIrcReply(host, NumericReply.RPL_ENDOFMOTD, ":$motdLine")
